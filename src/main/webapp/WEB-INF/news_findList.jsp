                ...
                <tr>
                    ...
                    <td>
                        <s:a href="newsUpdate.action?cid=%{#news.id}" class="btn btn-primary glyphicon glyphicon-pencil"
                             title="编辑"></s:a>
                        <s:a href="newsDelete.action?cid=%{#news.id}" class="btn btn-danger glyphicon glyphicon-trash btn-single-delete" title="删除" onclick="return confirm('确定删除吗？')"></s:a>
                    </td>
                </tr>
            </s:iterator>
            </tbody>
    ...
    <nav class="text-center">
        <ul class="pagination">
            ...
            <li class="active number">
                ...
                <a href="listNewsPart.action?pageNum=1&cid=${session.cid}">首页</a></li>
            </s:if>
            <s:if test="#session.pageNum!=1">
                <li class="number">
                    <a href="listNewsPart.action?pageNum=${session.pageNum-1}&cid=${session.cid}">上一页</a></li>
            </s:if>
            ...
            <s:if test="#session.pageNum!=#session.pageTotal">
                <li class="number"><a href="listNewsPart.action?pageNum=${session.pageNum+1}&cid=${session.cid}">下一页</a></li>
            </s:if>
            <s:if test="#session.pageNum!=#session.pageTotal">
                <li class="number"><a href="listNewsPart.action?pageNum=<s:property value="#session.pageTotal"/>&cid=${session.cid}">尾页</a></li>
            </s:if>

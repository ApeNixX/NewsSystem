...
<div class="page-header ">
    <h2 class="col-sm-offset-4 text-primary">发布新闻类型</h2>
</div>
<div class="container">
    <s:form method="post" action="categoryAdd" class="form-horizontal">
        <div class="form-group">
            <label for="inputUsername" class="col-sm-2 control-label">类型名</label>
            <div class="col-sm-3">
                <input type="text" id="inputUsername" name="category.categoryName" class="form-control" placeholder="请输入标题"
                       autofocus
                       required/>
            </div>
            <span id="error" style=" color: red ;font-size: 14px;" >${msg }</span><br/>

...
<div class="container">
    <div class="col-sm-8">
        <h1 class="blog-title"><s:property  value="news.title"/></h1>
        <div class="blog-info">
            <%--<span class="avatar"><img src="<%=basePath%>assets/images/user_face.jpg" alt="avatar"></span>--%>
            <span><s:property value="news.froms"/></span> |
            <span><s:property value="news.clicks"/>点击</span> |
            <span><s:property value="news.issueTime"/></span>
            <label class="label label-warning"><a style="color:black;" href="frontFindNewsByCategory.action?cid=<s:property value="news.category.id" />"><s:property value="news.category.categoryName"/></a></label>
            <%--<label class="label label-warning"><s:property value="news.category.categoryName"/></label>--%>
            <%--<label class="label label-success"><s:property value="news.category.categoryName"/></label>--%>
        </div>
        <div class="blog-content">
            <blockquote>
                <p><a style="color:black;" href="frontFindNewsByCategory.action?cid=<s:property value="news.category.id" />"><s:property value="news.category.categoryName"/>频道</a></p>
            </blockquote>
